...
#============
#
#ln_dLdx_f^-1*Q20%_A-0.0896782B0.452324_IMG_toPng.gp
#
...
#rgb: rgbColors[1]
#A and B
#(A,B) := (-0.0896782, 0.452324);
#
plot './ln_dLdx_f^-1*Q20%_A-0.0896782B0.452324_DATA.csv' using 1:($2-$3):($2+$3) with filledcurves notitle fillstyle solid 0.5 fillcolor rgb rgbColors[1], '' using 1:2 with lines title '{/Times {/:Italic f}({/:Italic x})^{-1}}' linecolor rgb rgbColors[1];
#---
#
#============
#
...
set output './ln_dLdx_f^-1*Q20%_A-0.0896782B0.452324_IMG.png';
#
set sample 1000;
#
...
#------------
set terminal png size 600,600;
set output './ln_dLdx_f^-1*Q20%_A-0.0896782B0.452324_log_IMG.png';
#
set sample 1000;
#
set logscale x 2;
