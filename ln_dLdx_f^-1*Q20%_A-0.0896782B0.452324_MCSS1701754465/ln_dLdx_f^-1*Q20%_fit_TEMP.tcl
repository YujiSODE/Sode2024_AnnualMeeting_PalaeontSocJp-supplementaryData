...
::MCSS::ADD_NOTE function {F(x) := (Ax+B)^-1*Q, where Q = 1+p(2u-1) and p = 0.2}
::MCSS::ADD_NOTE fittingLog {(Ax+B)^-1_fit_sampling_20231028N0_2023-Oct-28-23:28:26.log};
#
#A and B
::MCSS::ADD_NOTE constants "(A,B) := ([set A -0.0896782],[set B 0.452324])";
#
#=== format ===
::MCSS::SET_FORMAT %.1f;
#
...
#
#this file
::MCSS::INCLUDE {ln_dLdx_f^-1*Q20%_fit_TEMP.tcl};
#
#other source
::MCSS::INCLUDE {./sampling_20231028N0/(Ax+B)^-1_fit_sampling_20231028N0_2023-Oct-28-23:28:26.log};
#
#=== data input ===
...
while {$i<$M} {
	...
	while {$j<$size} {
		...
		#
		#y1
		set y1 [expr {[g $A $B $x1 $sgn]*[Q 0.2]}];
		#
		#y2
		set y2 [expr {[g $A $B $x2 $sgn]*[Q 0.2]}];
		#
		#y3
		set y3 [expr {[g $A $B $x3 $sgn]*[Q 0.2]}];
		#
...
#
#=== output ===
puts stdout [::MCSS::OUTPUT "ln_dLdx_f^-1*Q20%_A${A}B${B}"];
::MCSS::reset;
#
puts stdout "#---- end ---";
#
