...
::MCSS::ADD_NOTE function {F(x) := (Ax+B)^2*Q, where Q = 1+p(2u-1) and p = 0.2}
::MCSS::ADD_NOTE fittingLog {(Ax+B)^2_fit_sampling_20231028N0_2023-Oct-28-23:19:48.log};
#
#A and B
::MCSS::ADD_NOTE constants "(A,B) := ([set A 2.9851],[set B -1.91661])";
#
#=== format ===
::MCSS::SET_FORMAT %.1f;
#
...
#
#this file
::MCSS::INCLUDE {ln_dLdx_f^2*Q20%_fit_TEMP.tcl};
#
#other source
::MCSS::INCLUDE {./sampling_20231028N0/(Ax+B)^2_fit_sampling_20231028N0_2023-Oct-28-23:19:48.log};
#
#=== data input ===
...
#
#=== output ===
puts stdout [::MCSS::OUTPUT "ln_dLdx_f^2*Q20%_A${A}B${B}"];
::MCSS::reset;
#
puts stdout "#---- end ---";
#
