...
#============
#
#ln_dLdx_f^1*Q20%_A50.9704B-98.8064_IMG_toPng.gp
#
...
#(A, B) = (50.9704, -98.8064)
#
plot './ln_dLdx_f^1*Q20%_A50.9704B-98.8064_DATA.csv' using 1:($2-$3):($2+$3) with filledcurves notitle fillstyle solid 0.5 fillcolor rgb rgbColors[1], '' using 1:2 with lines title '{/Times {/:Italic f}({/:Italic x})^{1}}' linecolor rgb rgbColors[1];
#---
#
#============
#
...
set output './ln_dLdx_f^1*Q20%_A50.9704B-98.8064_IMG.png';
#
set sample 1000;
#
...
#------------
set terminal png size 600,600;
set output './ln_dLdx_f^1*Q20%_A50.9704B-98.8064_log_IMG.png';
#
set sample 1000;
set key left;
#
