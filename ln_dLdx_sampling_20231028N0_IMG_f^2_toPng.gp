...
#============
#
#ln_dLdx_sampling_20231028N0_IMG_f^2_toPng.gp
#
...
#
plot './ln_dLdx_f^2*Q20%_A2.9851B-1.91661_IMG/ln_dLdx_f^2*Q20%_A2.9851B-1.91661_DATA.csv' using 1:($2-$3):($2+$3) with filledcurves notitle fillstyle solid 0.5 fillcolor rgb rgbColors[3], '' using 1:2 with lines title '{/Times {/:Italic f}({/:Italic x)^{2}{/:Italic Q}}' linecolor rgb rgbColors[3];
#---
	#
	#f(x) = (Ax+B)^3*Q(0.2)
...
#
#output: png
#sample and f^2 -> output
#------------
set terminal png size 600,600;
set output './ln_dLdx_sampling_20231028N0_f^2_IMG.png';
#
set sample 1000;
