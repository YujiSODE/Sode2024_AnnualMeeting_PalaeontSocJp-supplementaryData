...
::MCSS::ADD_NOTE fittingLog {Ax+B_fit_sampling_20231028N0_2023-Oct-28-12:00:02.log};
#
#A and B
::MCSS::ADD_NOTE constants "(A,B) := ([set A 50.9704],[set B -98.8064])";
#
#=== format ===
::MCSS::SET_FORMAT %.1f;
#
...
#
#other source
::MCSS::INCLUDE {./sampling_20231028N0/Ax+B_fit_sampling_20231028N0_2023-Oct-28-12:00:02.log};
#
#=== data input ===
