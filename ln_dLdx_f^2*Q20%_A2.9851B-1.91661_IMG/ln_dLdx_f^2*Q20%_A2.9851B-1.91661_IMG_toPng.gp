...
#============
#
#ln_dLdx_f^2*Q20%_A2.9851B-1.91661_IMG_toPng.gp
#
...
#(A,B) := (2.9851, -1.91661)
#
plot './ln_dLdx_f^2*Q20%_A2.9851B-1.91661_DATA.csv' using 1:($2-$3):($2+$3) with filledcurves notitle fillstyle solid 0.5 fillcolor rgb rgbColors[1], '' using 1:2 with lines title '{/Times {/:Italic f}({/:Italic x})^{2}}' linecolor rgb rgbColors[1];
#---
#
#============
#
...
set output './ln_dLdx_f^2*Q20%_A2.9851B-1.91661_IMG.png';
#
set sample 1000;
#
...
#------------
set terminal png size 600,600;
set output './ln_dLdx_f^2*Q20%_A2.9851B-1.91661_log_IMG.png';
#
set sample 1000;
set key left;
#
